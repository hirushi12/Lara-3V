...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "qEgilSCB#PwaM_DqokLFJAxNDLUp2ZBM5B0kXBtsToCE8pmmdnQ0", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94765204896",
DEV: process.env.DEV || "94765204896",
